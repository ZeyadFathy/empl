...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        <div class="col-sm-8">
          <h3 class="box-title">List of Company_branch</h3>
        </div>
        <div class="col-sm-4">
          <a class="btn btn-primary" href="{{ route('department.create') }}">Add new Company_branch</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
      ...
      <div class="row">
        <div class="col-sm-12">
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                <th width="20%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending">Company_branch Name</th>
            ...
            <tfoot>
              <tr>
                <th width="20%" rowspan="1" colspan="1">Company_branch Name</th>
